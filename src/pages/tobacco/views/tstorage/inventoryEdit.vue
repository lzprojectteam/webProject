<template>
  <el-form :model="formItem" label-width="80px" :rules="ruleValidate" ref="formValidate">
    ...
    <el-row>
      ...
      <el-col :span="12">
        <el-form-item :label="$t('tobacco.tstorage.inventory.barcode')" prop="barcode">
    ...
    <el-row>
      <el-col :span="12">
        <el-form-item :label="$t('tobacco.tstorage.inventory.farmerName')">
          <el-input v-model="formItem.farmerName" v-bind:placeholder="$t('base.pleaseInput')"></el-input>
        </el-form-item>
      </el-col>
      <el-col :span="12">
    ...
    <el-row>
      <el-col :span="12">
        <el-form-item :label="$t('tobacco.tstorage.inventory.weight')">
          <el-input-number v-model="formItem.weight" style="width: 100%;"></el-input-number>
        </el-form-item>
      </el-col>
      <el-col :span="12">
        <el-form-item :label="$t('tobacco.tstorage.inventory.picture')">
          <el-input v-bind:placeholder="$t('base.pleaseInput')" v-model="formItem.picture"/>
        </el-form-item>
      </el-col>
    </el-row>
    <el-row>
    ...
    data() {
      return {
        ...
        ruleValidate: {
          ...
          barcode: [
            {required: true, message: '该项必须填写', trigger: 'blur'}
          ],
      ...
      onSubmitClick(name) {
        this.$refs[name].validate((valid) => {
          if (valid) {
            ...
            Promise.all([inventoryApi.updateInventory(this.formItem.id, this.formItem)])
              .then(([response]) => {
                this.formReset(name);
                //重置表单，允许多次操作
                this.$message({
