          ...
          <el-dropdown>
            ...
            <el-dropdown-menu slot="dropdown">
             <!-- <el-dropdown-item>
              ...
              <el-dropdown-item>
                <el-button type='primary' style="width:90px;" :disabled="cantEdit" @click='deleteButtonConfirm'>{{ $t('base.buttonDelete')
                  }}
                </el-button>
              </el-dropdown-item>
              <el-dropdown-item>
              ...
              <el-dropdown-item>
                <el-button type='primary' @click='dispatchDetails' style="width:90px;">出库单</el-button>
              </el-dropdown-item>
            </el-dropdown-menu>
          </el-dropdown>
        </el-button-group>
