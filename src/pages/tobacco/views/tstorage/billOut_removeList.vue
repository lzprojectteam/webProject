...
<template>
  <div class='mainPanel'>
        ...
        <el-button-group>
          ...
          <el-dropdown>
            ...
            <el-dropdown-menu slot="dropdown">
              ...
              <el-dropdown-item>
                <el-button type='primary' @click='dispatchDetails' style="width:90px;">入库单</el-button>
              </el-dropdown-item>
            </el-dropdown-menu>
          </el-dropdown>
        </el-button-group>
      ...
      <el-table
        ...
        <!--
                <el-table-column prop="bookId" :label="$t('tobacco.tstorage.stock.accountSet')" width="100"
                                 show-overflow-tooltip/>
        -->
        <el-table-column prop="serial" :label="this.$t('tobacco.tstorage.billOut.serial')" width="100"
                         show-overflow-tooltip
        />
        <el-table-column prop="number" :label="this.$t('tobacco.tstorage.billOut.number')" width="100"
                         show-overflow-tooltip
        />
        ...
        <el-table-column prop="region.title" :label="this.$t('tobacco.tstorage.stack.regionId')" width="100"
                         show-overflow-tooltip
        />
        <el-table-column prop="year" :label="this.$t('tobacco.tstorage.billOut.year')" width="100" show-overflow-tooltip
        />
        <el-table-column prop="month" :label="this.$t('tobacco.tstorage.billOut.month')" width="100"
                         show-overflow-tooltip
        />
        <el-table-column prop="title" :label="this.$t('tobacco.tstorage.billOut.title')" width="100"
                         show-overflow-tooltip
        />
        <el-table-column prop="author" :label="this.$t('tobacco.tstorage.billOut.author')" width="100"
                         show-overflow-tooltip
        />
        ...
        <el-table-column prop="destOrganizationName" :label="this.$t('tobacco.tstorage.billOut.organizationName')"
                         width="100"
                         show-overflow-tooltip/>
        <!--
        ...
        -->
        <el-table-column prop="tobaccoYear" :label="this.$t('tobacco.tstorage.billOut.tobaccoYear')" width="100"
                         show-overflow-tooltip/>
        <el-table-column prop="typeName" :label="this.$t('tobacco.tstorage.billOut.typeName')" width="100"
                         show-overflow-tooltip/>
        <el-table-column prop="statusName" :label="this.$t('tobacco.tstorage.billOut.statusName')" width="100"
                         show-overflow-tooltip/>
        <el-table-column prop="totalAmount" :label="this.$t('tobacco.tstorage.billOut.totalAmount')" width="100"
                         show-overflow-tooltip/>
        <el-table-column prop="totalWeight" :label="this.$t('tobacco.tstorage.billOut.totalWeight')" width="100"
                         show-overflow-tooltip/>
        <el-table-column prop="control.name" :label="this.$t('tobacco.tstorage.billOut.control')" width="100"
                         show-overflow-tooltip/>
        <el-table-column prop="transfer" :label="this.$t('tobacco.tstorage.billOut.transfer')" width="100"
                         show-overflow-tooltip>
          <template slot-scope="scope">
            {{scope.row.transfer === 1? '是': '否'}}
          </template>
        </el-table-column>
        <el-table-column prop="destBillId" :label="this.$t('tobacco.tstorage.billOut.destBillId')" width="100"
                         show-overflow-tooltip/>
        <el-table-column prop="desc" :label="this.$t('tobacco.tstorage.billOut.desc')" width="100"
                         show-overflow-tooltip/>
        <el-table-column
          fixed="right"
        ...
        <el-button-group style="height: 30px">
          <el-dropdown>
            ...
            <el-dropdown-menu slot="dropdown">
              ...
              <el-dropdown-item>
                <el-button type='primary' style="width:90px;" :disabled="cantEdit" @click='deleteButtonConfirm2'>{{
                  $t('base.buttonDelete')
                  }}
                </el-button>
              </el-dropdown-item>
          ...
          <el-button type="primary" style="float: right;margin-top:2px;" @click="onExpandClick2('formValidate')">
    ...
    <main class='contentPanel'>
      <el-table
        ...
        <el-table-column prop="statusName" :label="this.$t('tobacco.tstorage.billItem.statusName')" width="100"
                         show-overflow-tooltip/>
        <el-table-column prop="varietyName" :label="this.$t('tobacco.tstorage.billItem.varietyName')" width="100"
                         show-overflow-tooltip/>
        <el-table-column prop="gradeName" :label="this.$t('tobacco.tstorage.billItem.gradeName')" width="100"
                         show-overflow-tooltip/>
        ...
        <el-table-column prop="amount" :label="this.$t('tobacco.tstorage.billItem.amount')"/>
    ...
    <template>
      ...
      <el-dialog title="入库单" :visible.sync="childForm.billInForm" top="10px" width="80%">
        <bill-in-form :item=formData.viewSelect3 :visible.sync="childForm.billInForm" :isEdit='false'/>
      </el-dialog>
    </template>
  </div>
</template>
<script>
  const AddForm = () => import('./billOut_removeAdd.vue');
  const EditForm = () => import('./billOut_removeEdit.vue');
  const billInForm = () => import('./billInEdit.vue');
  ...
  export default {
    ...
    methods: {
      ...
      onExpandClick2() {
        if (this.expand2) {
          ...
          if (this.dataLength <= 2) {
            this.tableHeight = this.tableHeight + 35 * 3;
          } else if (this.dataLength > 2 && this.dataLength < 5) {
            this.tableHeight = this.tableHeight + 35 * (5 - this.dataLength);
          }
        }
      ...
      deleteButtonClick() {
        ...
        Promise.all([billOutApi.deleteBillOut2(this.formData.selectRow.id)])
          .then(([response]) => {
            this.$message({
              type: 'info',
              message: this.$t('message.deleteOk')
      ...
      onSearchButtonClick() {
        ...
        Promise.all([billOutApi.getAll({
          ...
          sort: 'serial,ASC',
          contains: 'bookId,serial,number,year,month,title,author,date,operation,destOrganizationId,organizationCode,organizationName,countryId,countryName,year,typeId,typeName,statusId,statusName,totalAmount,totalWeight,control,transfer,destBillId,desc,:{keyword}:true'.format({keyword: this.formData.pagination.keyword}),
